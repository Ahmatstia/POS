...
class $CustomersTable extends Customers
  ...
  @override
  late final GeneratedColumn<int> totalSpend = GeneratedColumn<int>(
    'total_spend',
    aliasedName,
    false,
    type: DriftSqlType.int,
...
class CustomerRow extends DataClass implements Insertable<CustomerRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['total_spend'] = Variable<int>(totalSpend);
  ...
  factory CustomerRow.fromJson(
    ...
    return CustomerRow(
      ...
      totalSpend: serializer.fromJson<int>(json['totalSpend']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'totalSpend': serializer.toJson<int>(totalSpend),
...
class CustomersCompanion extends UpdateCompanion<CustomerRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (totalSpend.present) {
      map['total_spend'] = Variable<int>(totalSpend.value);
    }
...
class $$CustomersTableFilterComposer
  ...
  ColumnFilters<int> get totalSpend => $composableBuilder(
...
class $$CustomersTableOrderingComposer
  ...
  ColumnOrderings<int> get totalSpend => $composableBuilder(
    column: $table.totalSpend,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CustomersTableAnnotationComposer
  ...
  GeneratedColumn<int> get totalSpend => $composableBuilder(
    column: $table.totalSpend,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<DateTime?> birthDate = const Value.absent(),
                Value<String?> notes = const Value.absent(),
                Value<int> totalSpend = const Value.absent(),
...
class $$StockMovementsTableTableManager
    extends
        RootTableManager<
          ...
          StockMovementRow,
          PrefetchHooks Function({bool productId, bool variantId, bool userId})
        > {
    ...
    $StockMovementsTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({productId = false, variantId = false, userId = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [],
                  addJoins:
